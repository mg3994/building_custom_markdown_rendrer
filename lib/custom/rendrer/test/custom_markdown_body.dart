...
import 'package:flutter_markdown_selectionarea/src/_functions_io.dart'
    if (dart.library.html) 'package:flutter_markdown_selectionarea/src/_functions_web.dart';

class MarkdownCustomBody extends MarkdownCustomWidget {
  const MarkdownCustomBody({
    super.key,
    required super.data,
...
abstract class MarkdownCustomWidget extends StatefulWidget {
  ...
  @override
  State<MarkdownCustomWidget> createState() => _MarkdownCustomWidgetState();
}
...
class _MarkdownCustomWidgetState extends State<MarkdownCustomWidget>
  ...
  @override
  void didUpdateWidget(MarkdownCustomWidget oldWidget) {
  ...
  void _parseMarkdown() {
    ...
    _children = [Text(builder.extractTextFromElement(astNodes.last) ?? "")];
    // .build(astNodes)
    ;
  }
